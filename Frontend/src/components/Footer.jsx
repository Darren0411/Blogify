...
const Footer = () => {
  ...
  return (
    <footer className="w-full bg-gray-900 text-white relative">
      ...
      <button
        onClick={scrollToTop}
        className="absolute -top-6 left-1/2 transform -translate-x-1/2 bg-gradient-to-r from-indigo-600 to-purple-600 text-white p-3 rounded-full shadow-lg hover:from-indigo-700 hover:to-purple-700 transition-all duration-300 hover:scale-110 z-10"
      >
            ...
            <div className="lg:col-span-1">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400 -mt-1">Where Ideas Come Alive</p>
                </div>
              </div>
              ...
              <div className="flex space-x-4">
                <a 
                  href="#" 
                  className="bg-gray-800 p-3 rounded-lg hover:bg-indigo-600 transition-all duration-300 hover:scale-110 hover:shadow-lg"
                  aria-label="Facebook"
                >
                ...
                <a 
                  href="#" 
                  className="bg-gray-800 p-3 rounded-lg hover:bg-blue-500 transition-all duration-300 hover:scale-110 hover:shadow-lg"
                  aria-label="Twitter"
                >
                ...
                <a 
                  href="#" 
                  className="bg-gray-800 p-3 rounded-lg hover:bg-pink-600 transition-all duration-300 hover:scale-110 hover:shadow-lg"
                ...
                <a 
                  href="#" 
                  className="bg-gray-800 p-3 rounded-lg hover:bg-gray-600 transition-all duration-300 hover:scale-110 hover:shadow-lg"
                  aria-label="GitHub"
                >
              ...
              <div>
                ...
                <div className="flex flex-col space-y-2">
                  <input
                    ...
                    className="bg-gray-800 border border-gray-700 rounded-lg px-4 py-2 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-300"
                  />
                  <button className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-4 py-2 rounded-lg hover:from-indigo-700 hover:to-purple-700 transition-all duration-300 font-medium hover:scale-105 hover:shadow-lg">
                    Subscribe
                  </button>
                </div>
              </div>
      ...
      <div className="w-full border-t border-gray-800 bg-gray-950/50">
        <div className="max-w-7xl mx-auto px-4 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex items-center space-x-6 text-gray-400 text-sm">
              <Link to="/privacy" className="hover:text-indigo-400 transition-colors hover:underline">
                Privacy Policy
              </Link>
              <Link to="/terms" className="hover:text-indigo-400 transition-colors hover:underline">
                Terms of Service
              </Link>
              <Link to="/cookies" className="hover:text-indigo-400 transition-colors hover:underline">
                Cookie Policy
              </Link>
            </div>
          </div>
